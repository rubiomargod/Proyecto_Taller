                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-center gap-1">
                      <button class="btn btn-primary btn-sm" wire:click="AbrirEditar({{$Mecanico->idMecanico}})">
                        <i class="bi bi-pencil"></i>
                      </button>
                      <button class="btn btn-danger btn-sm" wire:click="AbrirBorrar({{$Mecanico->idMecanico}})">
